...
# Agregar opción para abrir Network Manager
nm_option="󰖩  Open Network Manager"
...
elif [ "$chosen_network" = "󰖩  Open Network Manager" ]; then
    nm-connection-editor  # Abre el Network Manager
else 
